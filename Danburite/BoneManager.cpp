...
namespace Danburite
{
	...
	Bone &BoneManager::createBone(const string &name, const mat4 &offsetMatrix, const mat4 &hierarchyMatrix)
	{
		...
		return *__bones.emplace_back(make_unique<Bone>(boneID, name, offsetMatrix, hierarchyMatrix));
	}
