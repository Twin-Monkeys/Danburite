...
namespace Danburite
{
	enum class VertexAttributeType : unsigned
	{
		...
		POS3_NORMAL3_TEXCOORD2_TANGENT3		= unsigned(VertexAttributeFlag::POS3 | VertexAttributeFlag::NORMAL3 | VertexAttributeFlag::TEXCOORD2 | VertexAttributeFlag::TANGENT3),
	...
	{
		lhs = VertexAttributeType(unsigned(lhs) | unsigned(rhs));
		return lhs;
	}
}