...
namespace Danburite
{
	enum class MaterialOptionFlag : GLuint
	{
		...
		EMISSIVE_TEXTURE	= 0b0000'0000'0000'1000U,
		SHININESS_TEXTURE	= 0b0000'0000'0001'0000U,
		ALPHA_TEXTURE		= 0b0000'0000'0010'0000U,
		NORMAL_TEXTURE		= 0b0000'0000'0100'0000U
	};
