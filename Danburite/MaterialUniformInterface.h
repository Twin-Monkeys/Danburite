...
namespace Danburite
{
	class MaterialUniformInterface : public UniformInterface<272ULL>
	{
	public:
		...
		const SpecializedUniformField<GLuint64> environmentTex	= _createField<GLuint64>(144ULL);
		const SpecializedUniformField<GLuint> type				= _createField<GLuint>(160ULL);
		const SpecializedUniformField<GLuint> optionFlag		= _createField<GLuint>(176ULL);
		const SpecializedUniformField<GLuint> vertexFlag		= _createField<GLuint>(192ULL);
		const SpecializedUniformField<GLfloat> gamma			= _createField<GLfloat>(208ULL);
		const SpecializedUniformField<GLfloat> emissiveStrength	= _createField<GLfloat>(224ULL);
		const SpecializedUniformField<GLfloat> shininess		= _createField<GLfloat>(240ULL);
		const SpecializedUniformField<GLfloat> overriddenAlpha	= _createField<GLfloat>(256ULL);
